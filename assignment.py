...
third_number = int(input("Input a third number: "))
...
value2 = int(input("Input a second number: "))
value3 = int(input("Input a third number: "))
if value1 < value2 or value1 < value3:
    if value2 > value3:
        print(value2, "is the highest")
    else:
        print(value3, "is the highest")
else:
    print(value1, "is the highest")
...
n3 = int(input("Input a third number: "))
...
# OR
# Not decreasing
n1 = int(input("Input a whole number: "))
n2 = int(input("Input a second whole number: "))
n3 = int(input("Input a third whole number: "))
...
b = int(input("Input a second whole number: "))
c = int(input("Input a third whole number: "))
if a != b and a != c:
    if b == c:
        print("Two same")
    else:
...
def compare_three(a,b,c):
    if a != b and a != c:
        ...
        print("All different")
compare_three(10, 30, 10)
compare_three(100, 5, 50)
compare_three(7, 7, 7)
# TASK 40:
# Create a function named:
#
